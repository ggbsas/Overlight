...
Overlight is a Windows application that reduces screen brightness using the Windows Magnification API. Designed for better eye comfort, especially in low-light environments, without the need to manually adjust your monitor’s hardware brightness.
